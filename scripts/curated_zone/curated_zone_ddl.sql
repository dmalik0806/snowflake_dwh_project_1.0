/*
===============================================================================
DDL Script: Create Curated Zone Tables
===============================================================================
Script Purpose:
    Preparing the 'curated_zone' schema tables to ingest the data from landing_zone
===============================================================================
*/
use schema curated_zone;

create transient table if not exists curated_customer (
...
create transient table if not exists curated_item (
...
create transient table if not exists curated_order (
